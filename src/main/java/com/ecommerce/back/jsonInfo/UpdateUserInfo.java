...
@ApiModel(value="UpdateUserInfo", description = "Information for updating user")
public class UpdateUserInfo {
    ...
    public UpdateUserInfo(String userName, String password, String imgBase64String, String imgType, String mail) {
