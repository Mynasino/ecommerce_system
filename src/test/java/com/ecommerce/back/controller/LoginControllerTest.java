...
public class LoginControllerTest {
    ...
    public void loginUserTest() throws Exception {
        ...
        request = post("/login/user")
                .param("userName", "jack1")
                .param("password", "jack_pw");
        ...
        String contentString = mockMvc.perform(request)
                ...
                .getContentAsString();
        //json匹配下发的JWTInfo
        Assert.assertNotEquals(0, contentString.length());
        JSON.parseObject(contentString, JWTInfo.class);
    }
